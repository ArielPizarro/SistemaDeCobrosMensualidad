            ...
            <form method="post" id="form_compra" name="form_compra" action="<?php echo base_url(); ?>/compras/guarda" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Escribe el código y presiona enter" onkeyup="buscarProducto
                            (event, this, this.value)" autofocus />
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4">
                            <label><br>&nbsp;</label>
                            <button id="agregar_producto" name="agregar_producto" type="button" class="btn btn-primary" onclick="agregarProducto(id_producto.value,
