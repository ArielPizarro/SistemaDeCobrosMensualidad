        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <label>Este alumno debe cancelar en el año la suma de: $<?php echo $debe; ?>, en 10 cuotas mensuales de : $<?php echo $debe / 10; ?></label>
                </div>

                <div class="col-12 col-sm-6">

                    <label>Este alumno ha cancelado en el año la suma de: $<?php echo 0 + $totalPagado['monto']; ?></label>
            ...
            <form method="post" action="<?php echo base_url(); ?>/pagos/insertar" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input class="form-control" id="idalumno" name="idalumno" type="hidden" value="<?php echo $alumno['id']; ?>" required />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <label>Ingrese la fecha en que realizaron la transferencia:</label>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <label>Ingrese un detalle de la transaccion:</label>
