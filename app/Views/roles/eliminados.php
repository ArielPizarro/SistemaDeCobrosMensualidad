                ...
                <tbody>
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#EliminarModal" data-bs-whatever="<?= base_url('/unidades/reingresar/' . $dato['id']) ?>"><i class="fas fa-arrow-alt-circle-up"></i></td>
