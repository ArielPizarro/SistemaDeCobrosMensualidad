                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="ui-widget">
                                ...
                                <input type="text" class="form-control" id="cliente" name="cliente" placeholder="Escribe el nombre del cliente" value="" onkeyup="" autocomplete="off" required autofocus />
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Escribe el código y presiona enter" onkeyup="agregarProducto(event, this.value, 1, '<?php echo $idVentaTmp; ?>');" autofocus />
                        </div>
                        <div class="col-sm-2">
                            <label for="codigo" id="resultado_error" stype="color:red"></label>
                        </div>
